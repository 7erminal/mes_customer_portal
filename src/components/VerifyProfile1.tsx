...
const VerifyProfile1: React.FC<Props> = ({show, handleClose, proceed})=>{
            ...
            <Row>
                <Col xs={12} md={6}>
                    <FloatingLabel
                        ...
                        className="mb-3"
                        >   
                    <Form.Control type="text" value={applicationContext?.rphoneNumber} onChange={(e)=>applicationContext?.setRphoneNumber(e.target.value)} placeholder="Official business contact" className="custom-input-login-r" required />
                    </FloatingLabel>
                </Col>
                <Col xs={12} md={6}>
                    <FloatingLabel

...
const HomepageContent: React.FC<Props> = ({page})=>{    
    return <>
        <SideMenu page={page} />
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="d-flex flex-column h-100">
                    <p className="mb-1 pt-2 text-bold">MES TECH</p>
                    <h5 className="font-weight-bolder">We Provide SMS services</h5>
                    <p className="mb-5">Ads and notices can be displayed here</p>
          ...
          <div className="card h-100 p-3">
            <div className="overflow-hidden position-relative border-radius-lg bg-cover h-100" style={{backgroundImage: "url('../assets/img/ivancik.jpg');"}}>
              ...
              <div className="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 className="text-white font-weight-bolder mb-4 pt-2">Work with a reliable provider</h5>
        ...
        <div className="col-lg-5 mb-lg-0 mb-4">
          <div className="card z-index-2">
            <div className="card-body p-3">
              ...
              <h6 className="ms-2 mt-4 mb-0"> Users </h6>
              ...
              <div className="container border-radius-lg">
                <div className="row">
                  <div className="col-3 py-3 ps-0">
                    ...
                    <h4 className="font-weight-bolder">40,000</h4>
                    <div className="progress w-75">
                      <div className="progress-bar bg-dark w-60" role="progressbar"></div>
                    </div>
                  </div>
                  <div className="col-3 py-3 ps-0">
                    <div className="d-flex mb-2">
                      ...
                      <p className="text-xs mt-1 mb-0 font-weight-bold">Messages</p>
                    </div>
                    <h4 className="font-weight-bolder">2m</h4>
                    <div className="progress w-75">
                      <div className="progress-bar bg-dark w-90" role="progressbar" ></div>
                    </div>
                  </div>
                  <div className="col-3 py-3 ps-0">
                    <div className="d-flex mb-2">
                      ...
                      <p className="text-xs mt-1 mb-0 font-weight-bold">Expenses</p>
                    </div>
                    <h4 className="font-weight-bolder">4535GHS</h4>
                    <div className="progress w-75">
                      <div className="progress-bar bg-dark w-30" role="progressbar" ></div>
                    </div>
                  </div>
                  <div className="col-3 py-3 ps-0">
                    <div className="d-flex mb-2">
                      ...
                      <p className="text-xs mt-1 mb-0 font-weight-bold">Unique recipients</p>
                    </div>
            ...
            <div className="card-body px-0 pb-2">
              <div className="table-responsive">
                <table className="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Send date</th>
                      <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Sender ID</th>
                      <th className="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Recipient</th>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div className="d-flex px-2 py-1">
                          ...
                          <div className="d-flex flex-column justify-content-center">
                            <h6 className="mb-0 text-sm">12 Aug 2024 09:50:00</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td className="align-middle text-center text-sm">
                        <span className="text-xs font-weight-bold">1000001013321</span>
                      </td>
                      <td className="align-middle">
                        <div className="progress-wrapper w-75 mx-auto">
                          <div className="progress-info">
                            <div className="progress-percentage">
                              <span className="text-xs font-weight-bold">Sent</span>
                            </div>
                          </div>

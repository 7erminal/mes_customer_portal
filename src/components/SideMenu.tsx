...
const SideMenu: React.FC<Props> = ({page})=>{
    ...
    <div className="sidenav-header">
      ...
      <a className="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span className="ms-1 font-weight-bold">MES TECH</span>
      </a>
    </div>
    ...
    <div className="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul className="navbar-nav">
        ...
        <li className="nav-item">
          <Link className={ page=="home" ? "nav-link  active" : "nav-link"} to="/" onClick={applicationContext?.showSideNav}>
        ...
        { applicationContext?.user?.IsVerified == true ?
        <li className="nav-item">
          <Link className={ page=="campaigns" ? "nav-link  active" : "nav-link"} to="/campaigns" onClick={applicationContext?.showSideNav}>
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span className="nav-link-text ms-1">Campaigns</span>
          </Link>
        </li> : ''
        }
        { applicationContext?.user?.IsVerified == true ?
        ...
        { applicationContext?.user?.IsVerified == true ?
        <li className="nav-item">
          <Link className={ page=="reports" ? "nav-link  active" : "nav-link"} to="/reports" onClick={applicationContext?.showSideNav}>
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg">
        ...
        <li className="nav-item">
          <Link className={ page=="profile" ? "nav-link  active" : "nav-link"} to="/profile" onClick={applicationContext?.showSideNav}>
            <div className="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div className="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        ...
        <div className="card-body text-start p-3 w-100">
          ...
          <div className="docs-info">
            ...
            <a href="#" target="_blank" className="btn btn-white btn-sm w-100 mb-0">Documentation</a>
          </div>
        </div>
      </div>

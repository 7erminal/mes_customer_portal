    ...
    <div className="card card-body blur shadow-blur mx-4 mt-n6 overflow-hidden">
      <div className="row gx-4" style={{width: '100%'}}>
        ...
        <div className="col-auto my-auto">
          <div className="h-100">
            <h5 className="mb-1">
              {applicationContext?.user?.FullName}
            </h5>
            <p className="mb-0 font-weight-bold text-sm">
            {applicationContext?.user?.Email}
            </p>
          </div>
        </div>
          ...
          <div className="nav-wrapper position-relative end-0">
            <ul className="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
              ...
              <li className="nav-item">
                <a className="nav-link mb-0 px-0 py-1 active " onClick={handleVerifyProfileShow} data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">
                  ...
                  <span className="ms-1">Verify profile</span>
                </a>
